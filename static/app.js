...
const translations = {
    English: {
        formHeading: 'GitHub Profile → Landing Page',
        ...
        backButtonText: '← Start New Analysis',
        ...
        tokenLoadedPlaceholder: '✓ Loaded from .env (you can override)',
        apiKeyLoadedPlaceholder: '✓ Loaded from .env (you can override)'
    },
    Turkish: {
        formHeading: 'GitHub Profili → Tanıtım Sitesi',
        formDescription: 'GitHub profilinizi yapay zekâ analiziyle profesyonel bir vitrine dönüştürün.',
        ...
        placeholderGithubToken: 'ghp_... (Settings → Developer settings → Personal access tokens)',
        labelApiUrl: 'LLM API URL',
        placeholderApiUrl: 'örn: https://api.openai.com/v1',
        labelApiKey: 'API Anahtarı',
        placeholderApiKey: 'sk-... (opsiyonel, Ollama için boş bırakılabilir)',
        labelModelName: 'Model Adı',
        placeholderModelName: 'örn: llama3, gpt-4o-mini, mistral',
        submitButton: 'Profili Analiz Et',
        loadingTitle: 'Profil analiz ediliyor...',
        loadingStatusInitial: 'GitHub verileri çekiliyor...',
        loadingStatus1: 'Repolar analiz ediliyor, kaynak kodlar okunuyor...',
        loadingStatus2: 'AI detaylı analiz yapıyor, bu biraz sürebilir...',
        loadingStatus3: 'Kod analizi devam ediyor... Büyük projeler daha uzun sürer.',
        loadingStatus4: 'Neredeyse bitti... AI tüm projeleri inceliyor.',
        errorTitle: 'Bir hata oluştu',
        errorButtonText: 'Tekrar Dene',
        errorMissingUsername: 'Lütfen GitHub kullanıcı adını girin.',
        errorUnknown: 'Sunucuya bağlanılamadı.',
        ...
        exportCsvLabel: 'CSV',
        exportMarkdownLabel: 'Markdown',
        backButtonText: '← Yeni Analiz Yap',
        useCasesTitle: 'Kullanım Senaryoları',
        markdownProjectsTitle: 'Projeler',
        markdownUseCases: 'Kullanım Senaryoları',
        markdownProblem: 'Problem',
        markdownTech: 'Teknoloji',
        markdownGeneratedBy: 'Git2Page tarafından oluşturuldu',
        htmlUseCases: 'Kullanım Senaryoları',
        htmlProfileButton: 'GitHub Profili',
        htmlProjectsHeading: 'Projeler',
        htmlGeneratedBy: 'Git2Page tarafından oluşturuldu',
        tokenLoadedPlaceholder: '✓ .env dosyasından yüklendi (üzerine yazabilirsiniz)',
        apiKeyLoadedPlaceholder: '✓ .env dosyasından yüklendi (üzerine yazabilirsiniz)'
    }
};
